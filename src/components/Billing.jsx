...
(
  <section id='product' className={layout.sectionReverse}>
    ...
    <div className={layout.sectionInfo}>
      ...
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}> Lorem ipsum dolor sit amet consectetur adipisicing elit. Provident aperiam, assumenda repellendus eos possimus excepturi autem est aspernatur quibusdam, laboriosam illum voluptates sit exercitationem delectus ipsa. Mollitia molestiae architecto expedita dolores id sit!</p>
